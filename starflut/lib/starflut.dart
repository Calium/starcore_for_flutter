...
class StarCoreFactory extends StarCoreBase {
  ...
  Future<int> initCore(bool serverFlag, bool showMenuFlag, bool showClientWndFlag, bool sRPPrintFlag, String debugInterface, int debugPort,
      String clientInterface, int clientPort) async {
    try {
      await Starflut.gc();
      return await Starflut.channel.invokeMethod('starcore_InitCore',
          [serverFlag, showMenuFlag, showClientWndFlag, sRPPrintFlag, debugInterface, debugPort, clientInterface, clientPort]);
    } on PlatformException catch (e) {
      print("{$e.message}");
  ...
  Future<StarServiceClass> initSimple(
      String serviceName, String servicePass, int clientPortNumber, int webPortNumber, List<String> dependService) async {
    try {
      await Starflut.gc();
  ...
  Future<void> regMsgCallBackP(MsgCallBackProc callBack) async {
    try {
      await Starflut.gc();
      if (callBack == null) {
        if (gMsgCallBack != null) await Starflut.channel.invokeMethod('starcore_regMsgCallBackP', false);
        gMsgCallBack = null;
      } else {
        if (gMsgCallBack == null) await Starflut.channel.invokeMethod('starcore_regMsgCallBackP', true);
...
class StarSrvGroupClass extends StarCoreBase {
  ...
  Future<StarServiceClass> createService(String FrameTag, String servicePath, String serviceName, String rootPass, int frameInterval,
      int netPkgSize, int uploadPkgSize, int downloadPkgSize, int dataUpPkgSize, int dataDownPkgSize, String derviceID) async {
    try {
      await Starflut.gc();
      String starTag = await Starflut.channel.invokeMethod('StarSrvGroupClass_createService', [
        this.starTag,
        servicePath,
        serviceName,
        rootPass,
  ...
  */
  ...
  Future<bool> runScriptEx(String scriptInterface, StarBinBufClass binBuf, String moduleName) async {
    try {
      ...
      return await Starflut.channel
          .invokeMethod('StarSrvGroupClass_runScriptEx', [this.starTag, scriptInterface, binBuf.starTag, moduleName]);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return false;
    }
  ...
  Future<bool> setWebServerPort(String host, int portnumber, int connectionNumber, int postSize) async {
    try {
      await Starflut.gc();
      return await Starflut.channel
          .invokeMethod('StarSrvGroupClass_setWebServerPort', [this.starTag, host, portnumber, connectionNumber, postSize]);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return false;
    }
  ...
  Future<bool> loadRawModule(String scriptInterface, String moduleName, String fileOrString, bool isString) async {
    try {
      await Starflut.gc();
      return await Starflut.channel
          .invokeMethod('StarSrvGroupClass_loadRawModule', [this.starTag, scriptInterface, moduleName, fileOrString, isString]);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return false;
    }
  ...
  Future<List> preCompile(String scriptInterfaceName, String scriptSegment) async {
    try {
      await Starflut.gc();
      Object result =
          await Starflut.channel.invokeMethod('StarSrvGroupClass_preCompile', [this.starTag, scriptInterfaceName, scriptSegment]);
      return Starflut.processOutputArgs(null, result);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return [false, "error..."];
...
class StarServiceClass extends StarCoreBase {
  ...
  Future<StarSrvGroupClass> operator [](Object object) async {
    try {
      await Starflut.gc();
  ...
  Future<List> runScript(String scriptInterface, String scriptBuf, String moduleName, String workDirectory) async {
    try {
      ...
      Object result = await Starflut.channel
          .invokeMethod('StarServiceClass_runScript', [this.starTag, scriptInterface, scriptBuf, moduleName, workDirectory]);
      return Starflut.processOutputArgs(null, result);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return [false, "error..."];
  ...
  Future<List> runScriptEx(String scriptInterface, StarBinBufClass binBuf, String moduleName, String workDirectory) async {
    try {
      await Starflut.gc();
      Object result = await Starflut.channel
          .invokeMethod('StarServiceClass_runScriptEx', [this.starTag, scriptInterface, binBuf.starTag, moduleName, workDirectory]);
      return Starflut.processOutputArgs(null, result);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return [false, "error..."];
  ...
  Future<List> doFile(String scriptInterface, String fileName, String workDirectory) async {
    try {
      await Starflut.gc();
      Object result =
          await Starflut.channel.invokeMethod('StarServiceClass_doFile', [this.starTag, scriptInterface, fileName, workDirectory]);
      return Starflut.processOutputArgs(null, result);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return [false, "error..."];
  ...
  Future<List> doFileEx(String scriptInterface, String fileName, String workDirectory, String moduleName) async {
    try {
      await Starflut.gc();
      Object result =
          await Starflut.channel.invokeMethod('StarServiceClass_doFileEx', [this.starTag, scriptInterface, fileName, moduleName]);
      return Starflut.processOutputArgs(null, result);
    } on PlatformException catch (e) {
      print("{$e.message}");
      return [false, "error..."];
  ...
  Future<StarObjectClass> newRawProxy(
      String FrameTag, String scriptInterface, StarObjectClass attachObject, String attachFunction, String proyInfo, int proxyType) async {
    try {
      await Starflut.gc();
      if (attachObject == null || (!(attachObject is StarObjectClass))) return null;
      String lTag = await Starflut.channel.invokeMethod(
          'StarServiceClass_newRawProxy', [this.starTag, scriptInterface, attachObject.starTag, attachFunction, proyInfo, proxyType]);
      if (lTag == null)
        return null;
      else {
        List<String> tags = lTag.split("+");
  ...
  Future<StarObjectClass> importRawContext(
      String FrameTag, String scriptInterface, String contextName, bool isClass, String contextInfo) async {
    try {
      await Starflut.gc();
      String lTag = await Starflut.channel
          .invokeMethod('StarServiceClass_importRawContext', [this.starTag, scriptInterface, contextName, isClass, contextInfo]);
      if (lTag == null)
        return null;
      else {
        List<String> tags = lTag.split("+");
...
class StarObjectClass extends StarCoreBase {
  ...
  Future<Object> call(String funcName, List args) async {
    try {
      ...
      Object retVal =
          await Starflut.channel.invokeMethod('StarObjectClass_call', [this.starTag, funcName, Starflut.processInputArgs(args)]);
      if (retVal is String) {
        String val = retVal;
        if (val.startsWith(Starflut.StarObjectPrefix)) {
          List<String> tags = val.split("+");
